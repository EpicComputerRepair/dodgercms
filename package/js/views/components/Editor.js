...
var codeMirror = null;
var testText = "Live Epic CMS Markdown Editor\n" +
    "========================\n" +
...
function getCodeMirror(element,text){
    if(codeMirror === null) {
...
module.exports = {
    ...
    view: function view() {
        return [
            m("div", {id: "codeView", oncreate: function(){
                getCodeMirror(document.getElementById("codeView"),testText);
            }}),
            m("div", m.trust(marked(testText)))
        ];
    }
};